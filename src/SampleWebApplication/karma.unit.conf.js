module.exports = function (config) {
    config.set({
        ...
        files: [
          { pattern: 'js/libs/angular/angular.js', watched: false, included: true, served: true },
          { pattern: 'js/libs/angular-mocks/angular-mocks.js', watched: false, included: true, served: true },
          'js/app/*.js',
          'js/app/**/*.js',
          'js/tests/unit/**/*.js',
          'views/**/*.html'
